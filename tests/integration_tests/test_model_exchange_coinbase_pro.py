...
def get_api_settings(filename):
    ...
    elif 'api_key' in config['coinbasepro'] and\
            'api_passphrase' in config['coinbasepro'] and\
            'api_url' in config['coinbasepro']:
...
def getValidOrderMarket() -> str:
    ...
    with open(filename) as config_file:
        ...
        if 'api_key' in config and ('api_pass' in config or 'api_passphrase' in config) and 'api_url' in config:
            api_key = config['api_key']
            api_secret = keyring.get_password("pycryptobot", api_key)
            ...
            if 'api_key' in config['coinbasepro'] and 'api_passphrase' in config['coinbasepro'] and 'api_url' in config['coinbasepro']:
                api_key = config['coinbasepro']['api_key']
                api_secret = keyring.get_password("pycryptobot", api_key)
                api_passphrase = config['coinbasepro']['api_passphrase']
                api_url = config['coinbasepro']['api_url']
